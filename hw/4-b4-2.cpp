...
{
	char choice;
	cout << "1.用I、J、K、L键控制上下左右(大小写均可，边界停止)(允许按左箭头时向下移动)" << endl;
	cout << "2.用I、J、K、L键控制上下左右(大小写均可，边界回绕)(允许按左箭头时向下移动)" << endl;
	cout << "3.用箭头键控制上下左右，边界停止(按大写HPKM时不准移动)" << endl;
	cout << "4.用箭头键控制上下左右，边界回绕(按大写HPKM时不准移动)" << endl;
	cout << "5.用I、J、K、L键控制上下左右(大小写均可，边界停止)(不允许按左箭头时向下移动)" << endl;
	cout << "6.用I、J、K、L键控制上下左右(大小写均可，边界回绕)(不允许按左箭头时向下移动)" << endl;
	cout << "0.退出" << endl;
